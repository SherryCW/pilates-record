...
const exercises: Exercise[] = [...towerExercises, ...matExercises, ...extraExercises, ...reformerExpansionExercises, ...reformerAdditionalExercises, ...reformerGeneratedExercises, ...moreExercises].filter(exercise => !(exercise.kind === 'Wunda Chair' && exercise.en === 'Mermaid'))
